...
const Login = () => {
  ...
  return (
    <div className="w-[100vw] h-screen content-center">
      ...
      <div className=" flex w-[165px]  bg-zinc-700 rounded-e-2xl rounded-s-2xl mx-auto p-1  ">
        <button className={`rounded-e-2xl rounded-s-2xl px-2 py-1 transition duration-300 ease-in-out ${toggleBtn ?" bg-green-500" :"  bg-transparent" }`} onClick={()=>{setToggleBtn(true);SlideRef.current.swiper.slidePrev();}}>Employee</button>
    ...
    >
      <SwiperSlide><div>
    <h2 className=" text-center text-2xl font-bold p-2">Employee LogIn </h2>
